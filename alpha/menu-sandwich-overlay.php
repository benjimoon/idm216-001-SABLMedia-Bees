...
$query = "SELECT * FROM sandwiches WHERE id = {$_GET['id']}";
...
?>
 ...
 $site_url = site_url();
          echo "
<img class='detail__item--image' src =' {$site_url}{$sandwich['image_path2']}'>
";
?>
      <div class="card-inner">
        <h2 class="detail__item--name"><?php echo $sandwich['title']?></h2>
        <h2 class="detail__item--price"><?php echo $sandwich['price']?> </h2>
        <p class="detail__item--description">
        <?php echo $sandwich['description']?> <br /><br/>
        </p>
