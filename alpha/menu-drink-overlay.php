...
$query = "SELECT * FROM drinks WHERE id = {$_GET['id']}";
...
?>
 ...
 $site_url = site_url();
          echo "
<img class='detail__item--image' src =' {$site_url}{$drink['image_path2']}'>
";
?>
      </div>
      <div class="card-inner">
        <h2 class="detail__item--name"><?php echo $drink['title']?></h2>
        <h2 class="detail__item--price"><?php echo $drink['price']?> </h2>
        <p class="detail__item--description">
        <?php echo $drink['description']?> <br /><br/>
        </p>
