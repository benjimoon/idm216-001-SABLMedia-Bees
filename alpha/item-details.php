...
<h2 class="detail__item--price">$<?php echo $meal['price'];?></h2>
<p class="detail__item--description"><?php echo $meal['description'];?></p><br>

<form action='<?php echo"{$site_url}/_includes/process_orders.php" ?>' method="POST">
          <label for="notes" class="">Special Instructions</label>
          <div>
            <br>
          <input id="rectangle" name="note" placeholder="Add special instructions..." type="text" class="special-notes"> 
          </div>
